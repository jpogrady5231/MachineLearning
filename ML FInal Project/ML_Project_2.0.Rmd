...
g3 <- ggplot(plot_dat, aes(x = education, fill = loan_status)) + 
  ...
  theme(panel.grid.major = element_blank(), 
       ...
       fill = "loan_status") +   scale_fill_manual(values = c(" Rejected" = "red", " Approved" = "green"),
                    labels = c(" Rejected" = "Rejected", " Approved" = "Approved")) 
...
g4 <- ggplot(plot_dat, aes(x = loan_status, y = no_of_dependents, fill = loan_status)) +
  geom_boxplot() +
  theme_set(theme_bw(base_size = 22) ) + 
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(), 
        panel.border = element_blank(), 
        panel.background = element_blank()) + labs(x = "Loan Status", title = "Number_of_Dependents",
       fill = "loan_status") +   scale_fill_manual(values = c(" Rejected" = "red", " Approved" = "green"),
                    labels = c(" Rejected" = "Rejected", " Approved" = "Approved")) 
